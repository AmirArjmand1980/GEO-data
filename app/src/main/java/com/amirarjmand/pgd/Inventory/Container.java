...
public class Container extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noTitle noTitle=new noTitle(Container.this);
        ...
        header.setText("Main Container Device of unit "+UnitNo);


        save=findViewById(R.id.Save);


        ReadDataFromExcel(Container.this, "Inventory List unit "+UnitNo+".xls");

        save.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SaveDatainxcel(Container.this, "Inventory List unit "+UnitNo+".xls");
    ...
    private void ReadDataFromExcel(Container container, String filename) {
        ...
        try {
            ...
            HSSFSheet CONTAINER = inv.getSheetAt(1);
            ...
            HSSFRow purg = CONTAINER.getRow(17);
            ...
            HSSFRow smok = CONTAINER.getRow(18);
            ...
            HSSFRow fire = CONTAINER.getRow(19);
            ...
            HSSFRow toxi = CONTAINER.getRow(20);
            ...
            HSSFRow flam = CONTAINER.getRow(21);
            ...
            HSSFRow firs = CONTAINER.getRow(23);
            ...
            HSSFRow radi = CONTAINER.getRow(24);
            ...
            HSSFRow refg = CONTAINER.getRow(25);
            ...
            HSSFRow sink = CONTAINER.getRow(26);
            ...
            HSSFRow exti = CONTAINER.getRow(27);
            ...
            HSSFRow chai = CONTAINER.getRow(28);
            ...
            HSSFRow thrm = CONTAINER.getRow(29);
            ...
            HSSFRow hydr = CONTAINER.getRow(34);
            ...
            HSSFRow antn = CONTAINER.getRow(35);
            HSSFCell ant1 = antn.getCell(4);
            HSSFCell ant2 = antn.getCell(5);
            HSSFCell ant3 = antn.getCell(3);
            c73.setText(flm1.toString());
            c74.setText(flm2.toString());
            c75.setText(flm3.toString());

            HSSFRow rack = CONTAINER.getRow(36);
            HSSFCell rac1 = rack.getCell(4);
            HSSFCell rac2 = rack.getCell(5);
            HSSFCell rac3 = rack.getCell(3);
            c76.setText(flm1.toString());
            c77.setText(flm2.toString());
            c78.setText(flm3.toString());
    ...
    private void SaveDatainxcel(Context context, String filename) {
        ...
        try {
            ...
            HSSFSheet CONTAINER = workbook.getSheetAt(1);
            ...
            HSSFRow faid = CONTAINER.getRow(23);
            ...
            HSSFRow refr = CONTAINER.getRow(25);
            ...
            HSSFRow h2mo = CONTAINER.getRow(34);
