...
public class BUS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noTitle noTitle=new noTitle(BUS.this);
        ...
        header.setText("BUS system of unit "+UnitNo);


        save=findViewById(R.id.Save);


        ReadDataFromExcel(BUS.this, "Inventory List unit "+UnitNo+".xls");

        save.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SaveDatainxcel(BUS.this, "Inventory List unit "+UnitNo+".xls");

            }
        });

    }
    private void ReadDataFromExcel(BUS BUS, String filename) {
        ...
        try {
            ...
            HSSFSheet BUS_SYSTEM = inv.getSheetAt(3);
            ...
            HSSFRow firs = BUS_SYSTEM.getRow(23);
    ...
    private void SaveDatainxcel(Context context, String filename) {
        ...
        try {
            ...
            HSSFSheet BUS_SYSTEM = workbook.getSheetAt(3);
